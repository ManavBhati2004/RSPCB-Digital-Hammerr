...
export const AimSection: React.FC = () => {
  return (
    <motion.div
      className="absolute inset-0 w-full h-full overflow-y-auto md:overflow-hidden flex items-start md:items-center justify-center bg-white z-10"
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-10 md:gap-12 pt-32 sm:pt-36 md:pt-32 pb-24">
        {/* Left Content */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-slate-900 mb-2 leading-tight">
